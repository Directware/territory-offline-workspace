...
const routes: Routes = [
  ...
  {path: 'congregations', component: CongregationsComponent, canActivate: [InitialConfigurationGuard, AppNotLockedGuard]},
  ...
  {path: 'territories', component: TerritoriesComponent, canActivate: [InitialConfigurationGuard, AppNotLockedGuard]},
  ...
  {path: 'all-visit-bans', component: WholeVisitBansComponent, canActivate: [InitialConfigurationGuard, AppNotLockedGuard]},
  {path: 'all-visit-bans/:territoryId/:id', component: VisitBanComponent, outlet: "second-thread"},
  ...
  {path: 'overdue-assignments/:publisherId', component: OverdueAssignmentsComponent, outlet: "second-thread"},
  ...
  {path: 'publishers', component: PublishersComponent, canActivate: [InitialConfigurationGuard, AppNotLockedGuard]},
  ...
  {path: 'settings', component: SettingsComponent, canActivate: [InitialConfigurationGuard, AppNotLockedGuard]},
  ...
  {path: 'initial-configuration', component: InitialConfigurationComponent, outlet: "global", canActivate: [AppAlreadyConfiguredGuard]},
