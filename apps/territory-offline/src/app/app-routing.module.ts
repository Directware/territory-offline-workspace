...
const routes: Routes = [
  ...
  {
    path: "print/:territoryId",
    component: PrintTerritoryComponent,
    outlet: "second-thread",
  },
  ...
  {
    path: "visit-bans/:territoryId",
    component: VisitBansComponent,
    outlet: "second-thread",
  },
  { path: "visit-ban", component: VisitBanComponent, outlet: "second-thread" },
  {
    path: "visit-ban/:territoryId",
    component: VisitBanComponent,
    outlet: "second-thread",
  },
  {
    path: "visit-ban/:territoryId/:id",
    component: VisitBanComponent,
    outlet: "second-thread",
  },

  {
    path: "assignments/:territoryId",
  ...
  {
    path: "assignment/:territoryId",
    component: AssignmentComponent,
    outlet: "second-thread",
  },
  {
    path: "assignment/:territoryId/:id",
    component: AssignmentComponent,
    outlet: "second-thread",
  },
  ...
  {
    path: "transfer/import-geo-json",
    component: ImportGeoJsonComponent,
    outlet: "second-thread",
  },
  {
  ...
  {
    path: "processing-due-after",
    component: ProcessingDueAfterComponent,
    outlet: "second-thread",
  },
  {
    path: "reassign-after",
    component: ReassignAfterComponent,
    outlet: "second-thread",
  },
  {
    path: "reassign-due-after",
    component: ReassignDueAfterComponent,
    outlet: "second-thread",
  },
