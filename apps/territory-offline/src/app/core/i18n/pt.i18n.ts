export const pt = {
  ...
  overdueAssigments: {
    ...
    shareOverdueFirstSentence:
      "De acordo com as minhas notas, tem as seguintes áreas:",
  ...
  publisher: {
    ...
    noneMessage:
      "Criar ou importar enunciadores para poder atribuir-lhes territórios.",
    reallyDelete: "Quer mesmo apagar este pregador?",
    canNotDelete:
      "{{firstName}} {{name}} ainda atribuiu áreas e, portanto, não pode ser apagado.",
  },
  settings: {
    general: "Geral",
  ...
  transfer: {
    ...
    export: {
      ...
      populationCount: "Contagem de endereços",
      lastReturnDate: "Last doing on",
      lastPublisher: "Último acto em",
      currentlyAssignedSince: "Actualmente atribuído desde",
      currentPublisher: "Actualmente atribuído a",
    },
    ...
    exportTerritoryNames: "EXCEL: áreas",
    ...
    importExcel: {
      ...
      chooseSheets:
        "Por favor seleccione em qual dos <strong>Sheets</strong> os seus dados são",
      chooseNameColumns:
        "Por favor, seleccione em qual das colunas o <strong>Nomes</strong> são.",
      chooseStreetColumn:
    ...
    import: {
      ...
      wrongFileType:
        "Tipo de ficheiro errado! Por favor, introduza um ficheiro Excel.",
      noJsonFile:
        "Tipo de ficheiro errado! Por favor, introduza um ficheiro JSON.",
  ...
  modal: {
    ...
    import: {
      ...
      potentiallyDeletedLine1:
        "Os seguintes dados não estão disponíveis na cópia de segurança!",
