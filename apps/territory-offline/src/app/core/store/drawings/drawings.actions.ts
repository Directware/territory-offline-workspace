...
export const BulkImportDrawings = createAction(
  '[Drawings] bulk import drawings',
  props<{ drawings: Drawing[] }>()
);
export const BulkImportDrawingsSuccess = createAction(
  '[Drawings] bulk import drawings success',
  props<{ drawings: Drawing[] }>()
);

export const UpsertDrawing = createAction(
  '[Drawings] upsert drawing',
  props<{ drawing: Drawing }>()
);
export const UpsertDrawingSuccess = createAction(
  '[Drawings] upsert drawing success',
  props<{ drawing: Drawing }>()
);
...
export const SaveDrawingPrintAlignmentConfiguration = createAction(
  '[Drawings] save drawing print alignment configuration',
  props<{ drawingId: string; config: TerritoryDrawingPrintConfiguration }>()
);
