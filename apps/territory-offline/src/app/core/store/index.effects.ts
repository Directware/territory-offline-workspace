...
export const effects = [SettingsEffects, AssignmentsEffects, DrawingsEffects, PublishersEffects, TagsEffects, TerritoriesEffects,
  VisitBansEffects, CongregationsEffects, LastDoingsEffects];
