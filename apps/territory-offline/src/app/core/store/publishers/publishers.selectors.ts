...
export const selectPublishers = createSelector(selectAll, (publishers) =>
  publishers.sort((p1, p2) => (p1.name.toLowerCase() > p2.name.toLowerCase() ? 1 : -1))
);

export const selectPublisherEntities = createSelector(selectEntities, (publishers) => publishers);
...
export const selectPublishersCount = createSelector(selectTotal, (total) => '' + total);

export const selectPublishersByFirstNameLetter = createSelector(selectPublishers, (publishers) => {
