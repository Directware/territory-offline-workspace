...
export class DatabaseService {
  ...
  public async load(
    ...
    return await this.appropriateDatabase[this.platform].load(
      prefix,
  ...
  public async bulkUpsert(prefix: string, entities: TimedEntity[]) {
    return await this.appropriateDatabase[this.platform].bulkUpsert(
      prefix,
      entities
    );
  }
  ...
  public async clearAllWithPrefix(prefix: string) {
    return await this.appropriateDatabase[this.platform].clearAllWithPrefix(
      prefix
    );
  }
}
