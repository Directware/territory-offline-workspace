...
export class DatabaseService
{
  ...
  {
    return await this.appropriateDatabase[this.platform].upsert(prefix, entity, excludeCongregationPrefix);
  }
  ...
  {
    return await this.appropriateDatabase[this.platform].bulkDelete(prefix, entities, excludeCongregationPrefix);
  }

  public async delete(prefix: string, entity: TimedEntity, excludeCongregationPrefix?: boolean): Promise<TimedEntity>
  {
    return await this.appropriateDatabase[this.platform].delete(prefix, entity, excludeCongregationPrefix);
  }
