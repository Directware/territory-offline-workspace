...
export class DataImportService
{
  ...
  {
    const importProgressDialogRef = this.matDialog.open(BackupImportProgressComponent, {disableClose: true});
  ...
  {
    return this.bulkImport(dailyReports, BulkImportDailyReports, 'dailyReports', BulkImportDailyReportsSuccess);
  }
