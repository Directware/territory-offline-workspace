...
const routes: Routes = [
  {
    ...
    canActivate: [InitialConfigurationNotDoneGuard],
    data: { animation: 'Welcome' },
  },
  {
    path: 'field-service',
    component: FieldServiceComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Time' },
  },
  {
    path: 'choose-month',
    component: ChooseMonthComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Modal' },
  },
  {
    path: 'choose-month-from-modal',
    component: ChooseMonthComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'ChooseMonth' },
  },
  {
    path: 'studies-input',
    component: StudiesInputComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Modal' },
  },
  {
    path: 'goals-input',
    component: GoalsInputComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Modal' },
  },
  {
  ...
  {
    path: 'edit-report',
    component: EditReportBeforeSendComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'EditReport' },
  },
  {
    path: 'settings',
  ...
  },
  {
    ...
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Territories' },
  },
  {
    path: 'territory/:id',
    component: TerritoryComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Territory' },
  },
  {
    path: 'territory/:id/return-territory',
    component: ReturnTerritoryCardComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'ReturnTerritory' },
  },
  {
    path: 'territory/:id/visit-ban',
    component: VisitBanComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Modal' },
  },
  {
    path: 'territory/:id/visit-ban/:visitBanId',
    component: VisitBanComponent,
    canActivate: [InitialConfigurationGuard],
    data: { animation: 'Modal' },
  },
