...
const modalSlideUpTransition = [
  ...
  group([
    ...
    query(':leave', [style({}), animate('0.25s ease-in-out', style({}))], { optional: true }),
  ]),
];
const modalSlideDownTransition = [
  ...
  group([
    ...
    query(':enter', [style({ zIndex: 10 }), animate('0.25s ease-in-out', style({}))], {
      optional: true,
    }),
  ]),
];
...
export const slideInAnimation = trigger('routeAnimations', [
  ...
  transition('Territory => Modal', modalSlideUpTransition),
  transition('Modal => Territory', modalSlideDownTransition),
