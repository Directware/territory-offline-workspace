...
import { groupOverseerFactory } from './group-overseer-report.factory';
...
describe('Test group overseer report structure', () => {
  it('should create full group overseer report structure', () => {
    ...
    const lastAssignment1 = createAssignment({
      publisherId: publisher1.id,
      territoryId: territory1.id,
      startTime: startTime,
    });
    const lastAssignment2 = createAssignment({
      publisherId: publisher2.id,
      territoryId: territory2.id,
      startTime: startTime,
    });
    const lastAssignment3 = createAssignment({
